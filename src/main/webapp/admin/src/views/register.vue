  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:#000;fontSize:28px;">疫情社区管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.dizhi" autocomplete="off" placeholder="地址" type="text" />
																								...
																								<!-- <div v-if="tableName=='yiliaozhuanjia'" class="input-group">
			   <div class="label">账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhanghao" class="input" type="text" placeholder="账号">
			   </div>
			 </div> -->
			<el-form-item label="账号" class="input" v-if="tableName=='yiliaozhuanjia'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='yiliaozhuanjia'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='yiliaozhuanjia'" class="input-group">
			...
			<el-form-item label="专家姓名" class="input" v-if="tableName=='yiliaozhuanjia'">
			...
			<el-form-item label="职称" class="input" v-if="tableName=='yiliaozhuanjia'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='yiliaozhuanjia'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='yiliaozhuanjia'" class="input-group">
			...
			<el-form-item label="价格" class="input" v-if="tableName=='yiliaozhuanjia'">
			...
			<el-form-item label="服务时间" class="input" v-if="tableName=='yiliaozhuanjia'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                                        ...
                                                                                                                        if((!this.ruleForm.zhanghao) && `yiliaozhuanjia` == this.tableName){
        this.$message.error(`账号不能为空`);
        return
      }
                                                                  if((!this.ruleForm.mima) && `yiliaozhuanjia` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                                                                                                                                                                                                                                                                  if(`yiliaozhuanjia` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
                                                if(`yiliaozhuanjia` == this.tableName && this.ruleForm.jiage&&(!this.$validate.isIntNumer(this.ruleForm.jiage))){
