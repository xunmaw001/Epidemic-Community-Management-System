          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="咨询回复" prop="zixunhuifu">
          <el-input v-model="ruleForm.zixunhuifu" 
              placeholder="咨询回复" clearable  :readonly="ro.zixunhuifu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="咨询回复" prop="zixunhuifu">
              <el-input v-model="ruleForm.zixunhuifu" 
                placeholder="咨询回复" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
