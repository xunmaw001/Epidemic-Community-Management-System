          ...
          <el-form-item class="input" label="地址" prop="dizhi">
              <el-input v-model="ruleForm.dizhi" 
                placeholder="地址" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="核算结果" prop="hesuanjieguo">
          <file-upload
          tip="点击上传核算结果"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.hesuanjieguo?ruleForm.hesuanjieguo:''"
          @change="hesuanjieguoUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.hesuanjieguo" label="核算结果" prop="hesuanjieguo">
            <el-button type="text" size="small" @click="download(ruleForm.hesuanjieguo)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="12">
  ...
  methods: {
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                        ...
                                                                        hesuanjieguoUploadChange(fileUrls) {
                this.ruleForm.hesuanjieguo = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                	addEditStyleChange() {
	  this.$nextTick(()=>{
