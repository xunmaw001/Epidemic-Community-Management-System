          ...
          <el-form-item class="input" label="名称" prop="mingcheng">
              <el-input v-model="ruleForm.mingcheng" 
                placeholder="名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报名理由" prop="baomingliyou">
          <el-input v-model="ruleForm.baomingliyou" 
              placeholder="报名理由" clearable  :readonly="ro.baomingliyou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报名理由" prop="baomingliyou">
              <el-input v-model="ruleForm.baomingliyou" 
                placeholder="报名理由" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="报名文件" prop="baomingwenjian">
          <file-upload
          tip="点击上传报名文件"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.baomingwenjian?ruleForm.baomingwenjian:''"
          @change="baomingwenjianUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.baomingwenjian" label="报名文件" prop="baomingwenjian">
            <el-button type="text" size="small" @click="download(ruleForm.baomingwenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="12">
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.mingcheng = true;
            continue;
	            	            ...
	            	            if(o=='baomingliyou'){
            this.ruleForm.baomingliyou = obj[o];
	    this.ro.baomingliyou = true;
            continue;
          }
	            	            if(o=='baomingwenjian'){
            this.ruleForm.baomingwenjian = obj[o];
	    this.ro.baomingwenjian = true;
            continue;
          }
	            	            if(o=='tijiaoriqi'){
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                ...
                                                baomingwenjianUploadChange(fileUrls) {
                this.ruleForm.baomingwenjian = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                                        	addEditStyleChange() {
	  this.$nextTick(()=>{
