          ...
          <el-form-item class="input" label="名称" prop="mingcheng">
              <el-input v-model="ruleForm.mingcheng" 
                placeholder="名称" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="代办费用" prop="daibanfeiyong">
          <el-input v-model="ruleForm.daibanfeiyong" 
              placeholder="代办费用" clearable  :readonly="ro.daibanfeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="代办费用" prop="daibanfeiyong">
              <el-input v-model="ruleForm.daibanfeiyong" 
                placeholder="代办费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="地址" prop="dizhi">
              <el-input v-model="ruleForm.dizhi" 
                placeholder="地址" readonly></el-input>
                                      ...
                                      <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="代办内容" prop="daibanneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.daibanneirong" label="代办内容" prop="daibanneirong">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.daibanneirong = true;
            continue;
	            	            ...
	            	            if(o=='daibanfeiyong'){
            this.ruleForm.daibanfeiyong = obj[o];
	    this.ro.daibanfeiyong = true;
            continue;
          }
	            	            if(o=='riqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yewudaiban/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yewudaibanCrossAddOrUpdateFlag = false;
                  this.parent.search();
