          ...
          <el-form-item class="input" label="物业费" prop="wuyefei">
              <el-input v-model="ruleForm.wuyefei" 
                placeholder="物业费" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车位费" prop="cheweifei">
          <el-input v-model="ruleForm.cheweifei" 
              placeholder="车位费" clearable  :readonly="ro.cheweifei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="车位费" prop="cheweifei">
              <el-input v-model="ruleForm.cheweifei" 
                placeholder="车位费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="水费" prop="shuifei">
          <el-input v-model="ruleForm.shuifei" 
              placeholder="水费" clearable  :readonly="ro.shuifei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="水费" prop="shuifei">
              <el-input v-model="ruleForm.shuifei" 
                placeholder="水费" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="电费" prop="dianfei">
          <el-input v-model="ruleForm.dianfei" 
              placeholder="电费" clearable  :readonly="ro.dianfei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="电费" prop="dianfei">
              <el-input v-model="ruleForm.dianfei" 
                placeholder="电费" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="天然气费" prop="tianranqifei">
          <el-input v-model="ruleForm.tianranqifei" 
              placeholder="天然气费" clearable  :readonly="ro.tianranqifei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="天然气费" prop="tianranqifei">
              <el-input v-model="ruleForm.tianranqifei" 
                placeholder="天然气费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宽带费用" prop="kuandaifeiyong">
          <el-input v-model="ruleForm.kuandaifeiyong" 
              placeholder="宽带费用" clearable  :readonly="ro.kuandaifeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宽带费用" prop="kuandaifeiyong">
              <el-input v-model="ruleForm.kuandaifeiyong" 
                placeholder="宽带费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  computed: {
                                                                                                                                                                zongfeiyong: {
                                                                                                                                                                                                                                                                                                                                                                                        get: function () {
        return 0+parseFloat(this.ruleForm.wuyefei)+parseFloat(this.ruleForm.cheweifei)+parseFloat(this.ruleForm.shuifei)+parseFloat(this.ruleForm.dianfei)+parseFloat(this.ruleForm.tianranqifei)+parseFloat(this.ruleForm.kuandaifeiyong)+parseFloat(this.ruleForm.qitafeiyong) || ''
      }
    },
                      },
  created() {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dianfei = true;
            continue;
	            	            ...
	            	            if(o=='tianranqifei'){
            this.ruleForm.tianranqifei = obj[o];
	    this.ro.tianranqifei = true;
            continue;
          }
	            	            if(o=='kuandaifeiyong'){
            this.ruleForm.kuandaifeiyong = obj[o];
	    this.ro.kuandaifeiyong = true;
            continue;
          }
	            	            if(o=='qitafeiyong'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `feiyongjiaona/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.feiyongjiaonaCrossAddOrUpdateFlag = false;
                  this.parent.search();
