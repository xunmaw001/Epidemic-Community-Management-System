      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="档案编号" prop="danganbianhao">
          <el-input v-model="ruleForm.danganbianhao" 
              placeholder="档案编号" clearable  :readonly="ro.danganbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="档案编号" prop="danganbianhao">
              <el-input v-model="ruleForm.danganbianhao" 
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                                                                                ...
                                                                                                <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医生建议" prop="yishengjianyi">
          <el-input v-model="ruleForm.yishengjianyi" 
              placeholder="医生建议" clearable  :readonly="ro.yishengjianyi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医生建议" prop="yishengjianyi">
              <el-input v-model="ruleForm.yishengjianyi" 
                placeholder="医生建议" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
          ...
          <el-form-item class="input" label="专家姓名" prop="zhuanjiaxingming">
              <el-input v-model="ruleForm.zhuanjiaxingming" 
                placeholder="专家姓名" readonly></el-input>
                                                                                ...
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="检查状况" prop="jianchazhuangkuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="检查状况"
                  v-model="ruleForm.jianchazhuangkuang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianchazhuangkuang" label="检查状况" prop="jianchazhuangkuang">
                    <span>{{ruleForm.jianchazhuangkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
            continue;
	            	            ...
	            	            if(o=='jianchazhuangkuang'){
            this.ruleForm.jianchazhuangkuang = obj[o];
	    this.ro.jianchazhuangkuang = true;
            continue;
          }
	            	            if(o=='bingshi'){
