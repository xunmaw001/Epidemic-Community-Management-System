...
public class HesuanjieguoController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,HesuanjieguoEntity hesuanjieguo, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			hesuanjieguo.setYonghuming((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,HesuanjieguoEntity hesuanjieguo, HttpServletRequest request){
        EntityWrapper<HesuanjieguoEntity> ew = new EntityWrapper<HesuanjieguoEntity>();
		PageUtils page = hesuanjieguoService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, hesuanjieguo), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R query(HesuanjieguoEntity hesuanjieguo){
		...
		return R.ok("查询核算结果成功").put("data", hesuanjieguoView);
    }
