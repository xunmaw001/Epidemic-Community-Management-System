...
public class ZixunhuifuController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ZixunhuifuEntity zixunhuifu, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ZixunhuifuEntity zixunhuifu, HttpServletRequest request){
        EntityWrapper<ZixunhuifuEntity> ew = new EntityWrapper<ZixunhuifuEntity>();
		PageUtils page = zixunhuifuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, zixunhuifu), params), params));
        return R.ok().put("data", page);
    }
