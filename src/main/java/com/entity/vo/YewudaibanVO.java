 ...
 */
public class YewudaibanVO  implements Serializable {
	...
	public void setDaibanfeiyong(Integer daibanfeiyong) {
	 ...
	 * 获取：代办费用
	 */
	public Integer getDaibanfeiyong() {
